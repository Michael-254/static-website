                    ...
                    <form method="POST" action="{{route('content.store')}}">
                        ...
                        <div class="space-y-12">
                            ...
                            <div class="border-b border-gray-900/10 pb-12">
                                <h2 class="text-base font-semibold leading-7 text-gray-900">Create Content</h2>
                                ...
                                <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                                    ...
                                    <div class="sm:col-span-3">
                                        ...
                                        <div class="mt-2">
                                            <input id="topic" name="topic" type="topic" value="{{old('topic')}}" class="block w-full rounded-md px-3 border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-orange-600 sm:text-xs sm:leading-6">
                                        </div>
                                        @if ($errors->has('topic'))
