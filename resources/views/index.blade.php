<x-website-layout>
	<div class="hero overlay" style="background-image: url('asset/images/hero_1.jpg'); ">
		<div class="container">
			<div class="row align-items-center justify-content-between">
				<div class="col-lg-4 me-auto text-start">
					<div class="" data-aos="fade-left"><span class="subheading">Welcome to Byfaith church</span></div>
					<div class="mb-4">
						<h1 data-aos="fade-left">Oh Safe To the Rock That Is Higher Than I</h1>
					</div>
					<div class="">
						<p class="mb-5" data-aos="fade-left" data-aos-delay="200">Far far away, behind the word
				...
				<div class="col-lg-5" data-aos="fade-left">
					<a href="https://www.youtube.com/watch?v=Eu9NArl-_24&ab_channel=josiahGithinji" target="_blank" class="video-bg">
		...
		<div class="container">
			<div class="row justify-content-between">
				...
				<div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
					<img src="asset/images/img_3.jpg" alt="Image" class="img-fluid rounded">
				</div>
			</div>
		</div>
	</div>
			...
			<div class="row g-5">
				<div class="col-12 col-sm-6 col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="0">
					<div class="sermon-entry">
						<a href="sermon-single.html"><img src="asset/images/img_1.jpg" alt="Image"
				...
				<div class="col-12 col-sm-6 col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="100">
					<div class="sermon-entry">
						<a href="sermon-single.html"><img src="asset/images/img_2.jpg" alt="Image"
								class="img-fluid mb-3 rounded"></a>
						<div class="sermon-body">
							<span class="date">15 Jan 2020 <span class="mx-2">&bullet;</span> By Pastor Campbell </span>
							<h3 class="mb-2"><a href="#">Living and Sharing The Gospel</a></h3>
				...
				<div class="col-12 col-sm-6 col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="100">
					<div class="sermon-entry">
						<a href="sermon-single.html"><img src="asset/images/img_4.jpg" alt="Image"
								class="img-fluid mb-3 rounded"></a>
						<div class="sermon-body">
							<span class="date">15 Jan 2020 <span class="mx-2">&bullet;</span> By Pastor Campbell </span>
							<h3 class="mb-2"><a href="#">Living and Sharing The Gospel</a></h3>
			...
			<div class="row g-5">
				<div class="col-lg-4" data-aos="fade-up" data-aos-delay="0">
					<div class="service text-center">
						<span class="flaticon-wheat mb-4 d-block"></span>
				...
				<div class="col-lg-4" data-aos="fade-up" data-aos-delay="100">
					<div class="service text-center">
						<span class="flaticon-church mb-4 d-block"></span>
						<h3 class="heading">Marriage</h3>
						<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia,
							there live the blind texts. </p>
						<p><a href="#" class="more">+ Read more</a></p>
					</div>
				...
				<div class="col-lg-4" data-aos="fade-up" data-aos-delay="200">
					<div class="service text-center">
						<span class="flaticon-bible mb-4 d-block"></span>
		...
		<div class="container">
			<div class="row align-items-center" data-aos="fade-up">
				<div class="col-lg-7 text-center text-md-start mb-4 mb-md-0">
					<h2 class="heading text-white">Join with us as we worship the Lord</h2>
				</div>
				<div class="col-lg-5 text-center text-md-end" data-aos="fade-up" data-aos-delay="100">
